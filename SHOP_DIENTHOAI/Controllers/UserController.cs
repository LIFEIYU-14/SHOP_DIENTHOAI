...
namespace SHOP_DIENTHOAI.Controllers
{
    public class UserController : Controller
    {
        public int GetDefaultUserRoleID()
        {
            ...
            //var defaultRole = dt.PHAN_QUYEN.FirstOrDefault(r => r.Ten_Quyen.ToLower() == "User");


            //if (defaultRole != null)
            //{
            //    return defaultRole.ID_Quyen;
            //}
            //else
            //{
        ...
        public ActionResult DangKy(NGUOI_DUNG nguoidung)
        {
            try
            {
                ...
                //        if (defaultRole == null)
                //        {
                //            defaultRole = new PHAN_QUYEN { Ten_Quyen = "User" };
                //            dt.PHAN_QUYEN.Add(defaultRole);
                //            dt.SaveChanges();
                //        }

                //        nguoidung.ID_Quyen = defaultRole.ID_Quyen;
